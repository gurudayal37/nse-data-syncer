...
STOP_LOSS_PCT = -0.10  # Exit if any stock drops more than 10% from entry during the month
...
def run_backtest():
    ...
    output_path = os.path.join(base_dir, 'web', 'src', 'data', 'backtest_results_simple_all_nifty_10pct_stop.json')
