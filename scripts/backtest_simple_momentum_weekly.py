...
def calculate_comprehensive_metrics(monthly_results, benchmark_results):
    ...
    # Sharpe Ratio (annualized, sqrt(52))
...
def run_backtest():
    ...
    # Check for existing results (Freeze logic)
    ...
    def calculate_stats_for_period(results, start_value=100000, initial_holdings=None):
        ...
        return total_transactions, total_fees_paid, net_return_after_fees, final_value
    
    bt_transactions, bt_fees, bt_net_return, _ = calculate_stats_for_period(backtest_results)
    ...
    cur_transactions, cur_fees, cur_net_return, cur_final_val = calculate_stats_for_period(current_results, start_value=100000, initial_holdings=last_bt_holdings)
