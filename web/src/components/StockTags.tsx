        ...
        return (
            <div className="flex flex-wrap items-center gap-1.5" ref={wrapperRef}>
                {tags.map((tag) => (
                    <span
                        key={tag}
                        className="inline-flex items-center gap-1 px-2 py-0.5 bg-indigo-50 text-indigo-700 border border-indigo-200 rounded text-xs font-medium"
                    >
                        {tag}
                        <button
                ...
                <div className="relative">
                    <input
                        ...
                        placeholder="+ Add tag"
                        className="w-24 focus:w-36 transition-all px-2 py-0.5 text-xs text-gray-600 placeholder-gray-400 bg-transparent border border-dashed border-gray-300 rounded hover:border-gray-400 focus:outline-none focus:border-indigo-400 focus:bg-white"
                    />
                    {open && totalOptions > 0 && (
                        <ul className="absolute z-50 left-0 top-full mt-1 bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden max-h-48 overflow-y-auto min-w-[140px]">
                            {suggestions.map((s, i) => (
                                <li
                                    key={s.id}
            ...
            <div className="relative flex gap-2" ref={wrapperRef}>
                <div className="relative flex-1">
                    <input
                        ...
                        className="w-full px-2.5 py-1.5 pr-7 text-xs text-gray-800 placeholder-gray-400 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-transparent"
                    />
                    {input && (
