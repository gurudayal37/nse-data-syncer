...
import backtestData from '@/data/backtest_results_quick_momentum_10pct_stop.json'
...
export default function QuickMomentum10PctStopStrategyPage() {
            ...
            <div className="min-h-screen bg-gray-50 p-8">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 text-blue-800">
                        ...
                        <p className="text-sm font-mono">python scripts/backtest_quick_momentum_10pct_stop.py</p>
                    </div>
                </div>
            </div>
        )
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-sm">
                        <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                            ...
                            <p className="text-blue-800">
                                Select top 15 stocks from High Cap Universe (&gt; 2000 Cr) with highest Quick Momentum Score.
                            </p>
                        </div>
