...
import backtestData from '@/data/backtest_results_us_simple_momentum_10pct_stop.json'
...
export default function USSimpleMomentum10PctStopStrategyPage() {
            ...
            <div className="min-h-screen bg-gray-50 p-8">
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <h1 className="text-3xl font-bold text-gray-900">US Simple Momentum + 10% Stop Strategy</h1>
                    </div>
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 text-blue-800">
                        ...
                        <p className="text-sm font-mono">python3 scripts/backtest_us_simple_momentum_10pct_stop.py</p>
                    </div>
                </div>
            </div>
        )
                ...
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-500 mt-1">
                            Russell 1000 Universe · 6M + 1Y Vol-Adjusted · Top 15 Stocks · Monthly Rebalancing · 10% Monthly Stop-Loss
                        </p>
                    </div>
                </div>
                ...
                <div className="bg-white shadow-sm rounded-lg border border-gray-200 p-6 mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-sm">
                        ...
                        <div className="bg-purple-50 p-4 rounded-lg border border-purple-100">
                            ...
                            <p className="text-purple-800">Volatility-adjusted returns over <strong>6M and 1Y</strong> (equal weight), z-scored across the universe each month.</p>
                        </div>
