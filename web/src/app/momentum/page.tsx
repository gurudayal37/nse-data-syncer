...
type SortField = 'nse_symbol' | 'name' | 'momentum_score' | 'change_1w' | 'change_1m' | 'change_3m' | 'change_6m' | 'change_1y'
...
export default async function MomentumPage(props: PageProps) {
    const searchParams = await props.searchParams
    const page = Number(searchParams.page) || 1
    const sort = (searchParams.sort as SortField) || 'momentum_score'
    ...
    const SortHeader = ({ field, label, align = 'right' }: { field: SortField, label: string, align?: 'left' | 'right' }) => {
        ...
        return (
            <Link
                href={`/momentum?page=${page}&sort=${field}&order=${newOrder}`}
            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex items-center justify-between mb-8">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900">Momentum Dashboard</h1>
                            <p className="text-gray-500 mt-1">Top momentum stocks ranked by volatility-adjusted returns</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden">
                            ...
                            <thead className="bg-gray-50 text-gray-900 border-b border-gray-200">
                                <tr>
                                    ...
                                    <th className="px-6 py-4 text-right">
                                        <SortHeader field="momentum_score" label="Momentum Score" />
                                    </th>
                                    <th className="px-6 py-4 text-right">
                    ...
                    <div className="px-6 py-4 border-t border-gray-200 flex items-center justify-between bg-gray-50">
                        ...
                        <div className="flex gap-2">
                            <Link
                                href={`/momentum?page=${page - 1}&sort=${sort}&order=${order}`}
