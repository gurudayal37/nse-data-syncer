        ...
        <div className="min-h-screen bg-gray-50 p-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-gray-900">Simple Momentum Weekly Strategy</h1>
                        <p className="text-gray-500 mt-1">
                            Buying Top 15 Simple Momentum Stocks from High Cap Universe (&gt; 2000 Cr) (6M &amp; 1Y only) • Weekly Rebalancing • Since 2018
                        </p>
                    </div>
                </div>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <ul className="text-sm text-orange-800 space-y-1.5 list-disc list-inside">
                                ...
                                <li>
                                    <strong>Illiquid extreme movers:</strong> Several holdings had large single-week gains
