...
import backtestData from '@/data/backtest_results_quick_momentum.json'
...
export default function QuickMomentumStrategyPage() {
            ...
            <div className="min-h-screen bg-gray-50 p-8">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 text-blue-800">
                        ...
                        <p className="text-sm font-mono">python scripts/backtest_quick_momentum.py</p>
                    </div>
                </div>
            </div>
        )
                ...
                <div className="bg-white shadow-sm rounded-lg border border-gray-200 p-6 mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
                        <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                            <h3 className="font-semibold text-blue-900 mb-2">1. Selection Universe</h3>
                            <p className="text-blue-800">
                                High Cap stocks with Market Cap &gt; 2000 Cr. Select the top 15 by <strong>Quick Momentum Score</strong>.
                            </p>
                        </div>
                        ...
                        <div className="bg-green-50 p-4 rounded-lg border border-green-100">
                            ...
                            <p className="text-green-800">
                                Equal weighting (6.67% per stock). Portfolio rebalanced on the <strong>1st of every month</strong>.
                                Stocks exiting the Top 15 are sold; new entrants are bought.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div>
                            ...
                            <ul className="text-sm text-orange-800 space-y-1.5 list-disc list-inside">
                                ...
                                <li>
                                    ...
                                    during 2020–2021. In practice, large positions couldn't be built or exited at those prices.
                                </li>
                                <li>
