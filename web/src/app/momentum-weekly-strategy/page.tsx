        ...
        <div className="min-h-screen bg-gray-50 p-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                        <div className="text-sm text-gray-500 mb-1">Win Rate (Weeks)</div>
                        <div className="text-3xl font-bold text-blue-600">
                            {summary.winRate}%
                        </div>
                        <div className="text-xs text-gray-400 mt-2">{summary.winningWeeks} out of {summary.totalWeeks} weeks</div>
                    </div>
                    <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                        ...
                        <div className="text-xs text-gray-400 mt-2">Last rebalanced: {data.length > 0 ? data[data.length - 1].week : '-'}</div>
                    </div>
                </div>
                        ...
                        <table className="w-full text-sm text-left">
                            <thead className="bg-gray-50 text-gray-900 font-medium">
                                <tr className="text-right">
                                    ...
                                    <th className="px-6 py-4 text-left">Week Ending</th>
