...
import backtestData from '@/data/backtest_results_us_simple_momentum.json'
...
export default function USSimpleMomentumStrategyPage() {
            ...
            <div className="min-h-screen bg-gray-50 p-8">
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <h1 className="text-3xl font-bold text-gray-900">US Simple Momentum Strategy</h1>
                    </div>
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 text-blue-800">
                        ...
                        <p className="text-sm font-mono">python3 scripts/backtest_us_simple_momentum.py</p>
                    </div>
                </div>
            </div>
        )
                ...
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-500 mt-1">
                            Russell 1000 Universe · 6M + 1Y Vol-Adjusted · Top 15 Stocks · Monthly Rebalancing · No Stop-Loss
                        </p>
                    </div>
                </div>
