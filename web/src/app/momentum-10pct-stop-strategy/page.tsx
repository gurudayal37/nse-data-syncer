                ...
                <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-500 mt-1">
                            Top 15 Momentum Stocks from High Cap (&gt; 2000 Cr) (3M, 6M &amp; 1Y) • Monthly Rebalancing • −15% GTT stop per stock per month
                        </p>
                    </div>
                </div>
                ...
                <div className="bg-white shadow-sm rounded-lg border border-gray-200 p-6 mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-sm">
                        ...
                        <div className="bg-red-50 p-4 rounded-lg border border-red-100">
                            <h3 className="font-semibold text-red-900 mb-2">4. Stop Loss (GTT)</h3>
                            <p className="text-red-800">
                                GTT order placed at <strong>−15%</strong> from entry. Gap-down opens below stop fill at open price (actual loss). Intraday touches fill at exactly −15%.
                            </p>
                        </div>
                    </div>
                </div>
