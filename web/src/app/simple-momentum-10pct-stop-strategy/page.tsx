                    ...
                    <div className="flex">
                        ...
                        <div className="ml-3">
                            ...
                            <div className="mt-2 text-sm text-yellow-700">
                                <p>
                                    This backtest uses the <strong>current</strong> Nifty Total Market universe for historical simulation.
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-sm">
                        <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                            ...
                            <p className="text-blue-800">
                                Select top 15 stocks from the <strong>Nifty Total Market</strong> universe with highest Simple Momentum Score.
                                Score is based on volatility-adjusted returns over <strong>6M and 1Y</strong> only (no 3M).
                            </p>
                        </div>
